...
if( ! function_exists( 'woodmart_theme_setup' ) ) {
	function woodmart_theme_setup() {
		...
		register_nav_menus( array(
			...
			'top-bar-menu' => esc_html__( 'Top Bar RIGHT Menu', 'woodmart' ),
			'top-bar-menu-left' => esc_html__( 'Top Bar LEFT Menu', 'woodmart' ),
		) );
...
if( ! function_exists( 'woodmart_allow_svg_upload' ) ) {
	add_filter( 'upload_mimes', 'woodmart_allow_svg_upload', 100, 1 );
	function woodmart_allow_svg_upload( $mimes ) {
	...
	function woodmart_register_required_plugins() {
	    ...
	    $plugins = array(
	        ...
	        array(
	            ...
	            'source'             => get_parent_theme_file_path( WOODMART_FRAMEWORK . '/plugins/js_composer.zip' ), // The plugin source.
	        ...
	        array(
	            ...
	            'source'             => get_parent_theme_file_path( WOODMART_FRAMEWORK . '/plugins/revslider.zip' ), // The plugin source.
	            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
	            'version'            => '5.4.6.6', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
	            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
	            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
	            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
	        ),
