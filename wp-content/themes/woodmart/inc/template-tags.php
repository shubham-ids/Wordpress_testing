...
if( ! function_exists( 'woodmart_header_block_search_extended' ) ) {
	function woodmart_header_block_search_extended( $search_type = false, $show_categories = true, $ajax = true, $ajax_args = array(), $wrap = true, $index = false ) {
		$class = '';
		$data  = '';
		...
		?>
			<form role="search" method="get" class="searchform <?php echo esc_attr( $class ); ?>" action="<?php echo esc_url( home_url( '/' ) ); ?>" <?php echo ( $data ); ?>>
				<div>
					...
					<input type="text" id="woocommerce-product-search-field-<?php echo isset( $index ) ? absint( $index ) : 0; ?>" class="search-field" placeholder="<?php echo ($placeholder); ?>" value="<?php echo get_search_query(); ?>" name="s" />
					...
					<button type="submit" class="searchsubmit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woodmart' ); ?>"><?php echo esc_attr_x( 'Search', 'submit button', 'woodmart' ); ?></button>
				</div>
			</form>
		...
		?>
			<form method="post" class="login woocommerce-form woocommerce-form-login <?php if ( $hidden ) echo 'hidden-form'; ?>" <?php echo ( ! empty( $action ) ) ? 'action="' . esc_url( $action ) . '"' : ''; ?> <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
				...
				<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide form-row-username">
					<label for="username"><?php esc_html_e( 'Username or email', 'woodmart' ); ?> <span class="required">*</span></label>
				...
				<p class="form-row">
					...
					<?php endif ?>
					<button type="submit" class="button woocommerce-Button" name="login" value="<?php esc_attr_e( 'Login', 'woodmart' ); ?>"><?php esc_html_e( 'Login', 'woodmart' ); ?></button>
				</p>
				...
				<div class="login-form-footer">
					...
					<label for="rememberme" class="remember-me-label inline">
						<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'woodmart' ); ?></span>
					</label>
				</div>
