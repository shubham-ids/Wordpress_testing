...
$is_shortcode = isset( $woodmart_loop['blog_type'] ) && $woodmart_loop['blog_type'] == 'shortcode';
...
if( $blog_design == 'masonry' && ( $is_shortcode || ! is_single() ) )
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	<div class="article-inner">
		<?php if ( $blog_design == 'default-alt' || is_single() && !$is_shortcode ): ?>
			...
			<?php if ( is_single() && $parts['title'] && !$is_shortcode ) : ?>
		...
		<div class="article-body-container">
			<?php if ( $blog_design != 'default-alt' && ( ! is_single() || $is_shortcode ) ): ?>
				...
				<?php if ( $parts['meta'] && ( ! is_single() || $is_shortcode ) ): ?>
					<div class="entry-meta woodmart-entry-meta">
						<?php woodmart_post_meta(array(
							'labels' => 1,
							'author' => 1,
			...
			<?php elseif( $parts['text'] ) : ?>
				<div class="entry-content woodmart-entry-content">
					<?php woodmart_get_content( $parts['btn'], is_single() && !$is_shortcode ); ?>
