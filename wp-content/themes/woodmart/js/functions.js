...
(function($) {
    ...
    woodmartThemeModule = (function() {
        ...
        var woodmartTheme = {
            ...
            ajaxLinks: '.woodmart-product-categories a, .widget_product_categories a, .widget_layered_nav_filters a, .woocommerce-widget-layered-nav a, .filters-area a, body.post-type-archive-product:not(.woocommerce-account) .woocommerce-pagination a, .woodmart-shop-tools a, .woodmart-woocommerce-layered-nav a, .woodmart-price-filter a',
            mainCarouselArg : {
        ...
        return {
            ...
            searchFullScreen: function() {
                ...
                var body = $('body'),
                    searchWrapper = $('.wrapper-search-full-screen'),
                    offset = 0;
                ...
                body.on("click", ".woodmart-close-search, .main-header, .sticky-header, .topbar-wrapp, .main-page-wrapper, .header-banner", function(event) {
                    ...
                    if ( ! $(event.target).is('.woodmart-close-search') && $(event.target).closest(".wrapper-search-full-screen").length ) return;
