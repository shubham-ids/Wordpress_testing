<div class="wrap">
  ...
  <a href="<?php echo admin_url('admin.php?page=add-new-district','admin'); ?>&&amp;action=add" class="page-title-action">Add New</a>
        ...
        <thead>
          <tr>
            ...
            <th 
              ...
              <a href="<?php echo admin_url('admin.php?page=add-new-district','admin')?>&order-by=title&order=<?php echo $order == 'desc'?'asc':'desc'; ?>">
          ...
          <tr id="post-1" class="iedit author-self level-0 post-1 type-post status-publish format-standard hentry category-uncategorized">
            <th scope="row" class="check-column"> 
             ...
             <td class="title column-title has-row-actions column-primary page-title" data-colname="Title">
                <strong>
                  <a class="row-title" href="<?php echo admin_url('admin.php?page=add-new-district','admin'); ?>&post=<?php echo $row->id; ?>&amp;action=edit"><?php echo $row->title; ?></a>
                </strong>

                <div class="row-actions">
                  <span class="edit"><a href="<?php echo admin_url('admin.php?page=add-new-district','admin'); ?>&post=<?php echo $row->id; ?>&amp;action=edit">Edit</a> | </span>
                  <span class="trash">
                    <a href="<?php echo admin_url('admin.php?page=add-new-district','admin'); ?>&task=delete&post=<?php echo $row->id; ?>" class="submitdelete">Trash
                    </a>
                  </span>
                </div>
              </td>
